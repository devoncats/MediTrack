...
class AlertViewModelFactory(context: Context, private val scheduleId: Long) : ViewModelProvider.Factory {
    ...
    private val postponeDoseUseCase = PostponeDoseUseCase(alarmScheduler)

    @Suppress("UNCHECKED_CAST")
    override fun <T : ViewModel> create(modelClass: Class<T>): T =
        AlertViewModel(medicationRepository, confirmDoseUseCase, postponeDoseUseCase, scheduleId) as T
}
